...
var relay = require('relayServerModule');
...
//	udpServer2.Start(pbBuilder);
	...
	var relayServer = new relay.relayServerModule(this);
	relayServer.Start(ownSessionId, extSessionId);
	relayServer.Start(extSessionId, ownSessionId);
}